...
<?php if ($latest->have_posts()) : while ($latest->have_posts()) : $latest->the_post(); ?><article <?php post_class('post-card panel'); ?>><div class="post-content"><div class="eyebrow"><?php $cats = get_the_category(); echo esc_html($cats ? $cats[0]->name : '未分类'); ?></div><h3 data-post-transition-title data-post-url="<?php echo esc_url(get_permalink()); ?>" data-post-id="<?php echo esc_attr(get_the_ID()); ?>"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3><p><?php echo esc_html(get_the_excerpt()); ?></p><footer><span><?php echo eno_format_date(); ?></span></footer></div><div class="post-icon"><i class="ti <?php echo esc_attr(eno_post_icon_class()); ?>" aria-hidden="true"></i></div></article><?php endwhile; wp_reset_postdata(); else : ?><div class="empty panel"><i class="ti ti-file-off" aria-hidden="true"></i><h3>还没有文章</h3><p>登录后台发布第一篇笔记。</p></div><?php endif; ?>
