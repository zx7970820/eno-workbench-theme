...
<section class="content-layout">
  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?><article <?php post_class('post-card panel'); ?>><div class="post-content"><h3 data-post-transition-title data-post-url="<?php echo esc_url(get_permalink()); ?>" data-post-id="<?php echo esc_attr(get_the_ID()); ?>"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h3><p><?php echo esc_html(get_the_excerpt()); ?></p><div class="tags"><?php foreach (array_slice(get_the_category(), 0, 2) as $cat) : ?><span><?php echo esc_html($cat->name); ?></span><?php endforeach; ?></div><footer><span><?php echo esc_html(get_the_date('Y-m-d')); ?></span></footer></div><div class="post-icon"><i class="ti <?php echo esc_attr(eno_post_icon_class()); ?>" aria-hidden="true"></i></div></article><?php endwhile; else : ?><div class="empty panel"><h2>没有找到文章</h2><p>试试其他关键词。</p></div><?php endif; ?>
